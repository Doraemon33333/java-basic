...
public class DataType {
    ...
    * */
    ...
    // 메서드 이름은 같게(print)
    // 매게변수 개수, 타입 달라야함
    // 반환 타입은 오버로딩에 영향을 주지 않는다 (매게변수 같고 반환값만 다른것은 각 매서드를 구분할수없음(3줄 밑에있는 그거))
    public static void print(double a){
        System.out.println("숫자 출력함 " + a);
    }
    public static void print(int i){
        System.out.println("숫자 출력함 " + i);
    }
    /*public static void int print(int a){
        System.out.println(a);
        return 1;
    }*/
    public static void print(boolean b){
        System.out.println("논리형 출력함 " +b);
    }
    public static void print(String c){
        System.out.println("문자 출력함 " +c);
    }
}
